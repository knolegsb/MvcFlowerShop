...
GO
IF OBJECT_ID(N'[dbo].[FK_OrderOrdersDetail]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[OrdersDetails] DROP CONSTRAINT [FK_OrderOrdersDetail];
GO
IF OBJECT_ID(N'[dbo].[FK_ProductOrdersDetail]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[OrdersDetails] DROP CONSTRAINT [FK_ProductOrdersDetail];
GO
